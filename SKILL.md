...
- **去重铁律（2026-08-08 用户反馈修复 + 2026-08-10 强化）**：选题前必须 `ls /Volumes/外接硬盘/hermes-images/daily-image-training/2026-*/` 列出全部历史产出文件名 + 读各 README 的 style_key，排除历史所有场次已用主题（渔夫/补网/灯塔/雪山等同场景同主体一律视为重复），AM/PM/历史完全不重叠
